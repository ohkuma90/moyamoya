...
ActiveRecord::Schema[7.0].define(version: 2023_09_18_060832) do
  create_table "declarations", charset: "utf8", force: :cascade do |t|
  ...
  create_table "worries", charset: "utf8", force: :cascade do |t|
